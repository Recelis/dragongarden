...
const Childrens = () => {
    return (
        <div className="menu-category">
            <h3 className="menu-subheading">Children's Menu </h3>
            ...
            <MenuItem itemNumber="88" itemName="Ice Cream Sundae (Strawberry, Caramel or Chocolate Flavouring)" itemPrice="5.50"/>
        </div>
    );
}
